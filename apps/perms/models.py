...
#
#
class NaviPermission(models.Model):
    id = models.UUIDField(default=uuid.uuid4, primary_key=True)
    name = models.CharField(max_length=128, unique=True, verbose_name=_('Name'))
    navi = models.ForeignKey('navis.navi', on_delete=models.CASCADE, verbose_name=_("Navi"))
    users = models.ManyToManyField(User, related_name='navi_user_permissions', blank=True, verbose_name=_("User"))
    user_groups = models.ManyToManyField(UserGroup, related_name='navi_user_groups_permissions', blank=True,
    ...
    class Meta:
        verbose_name = _("Navi permission")
